...
public class FreeskiingService
{
    private readonly List<FreeskiingArea> _areas = new()
    {
        ...
        new FreeskiingArea
        {
            ...
            Access = "Lift-accessed",
            ImageUrl = "https://images.unsplash.com/photo-1544986581-efac024faf62?w=800&h=600&fit=crop",
            AvalancheGearRequired = true,
        ...
        new FreeskiingArea
        {
            ...
            Access = "Ski touring",
            ImageUrl = "https://images.unsplash.com/photo-1545572695-7f27679e47c2?w=800&h=600&fit=crop",
            AvalancheGearRequired = true,
            BestMonths = "March - May"
        },
        new FreeskiingArea
        ...
        new FreeskiingArea
        {
            ...
            Access = "Lift-accessed",
            ImageUrl = "https://images.unsplash.com/photo-1565992441121-4367c2967103?w=800&h=600&fit=crop",
            AvalancheGearRequired = true,
